...
static unsigned long long	ft_float_buffer(long double num, char *buffer, t_print *const restrict clipb)
{
...
static int				ft_isinfnan(float f, t_print *const restrict clipb)
{
	long l;
