...
#    Updated: 2019/09/13 10:25:24 by jesmith       ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
SOURCE := printf asprintf vdprintf dispatcher format flinit flagharvest functblinit rounder padder flag_verificators handling
